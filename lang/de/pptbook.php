...
/**
 * Language strings for mod_pptbook (de).
 *
 * @package    mod_pptbook
...
$string['noinstances'] = 'In diesem Kurs gibt es keine PPT-Bücher.';
$string['page'] = 'Seite {$a}';
$string['perpage'] = 'Folien pro Seite';
$string['perpagedesc'] = 'Legen Sie fest, wie viele Folien auf jeder Seite angezeigt werden sollen';
$string['pluginadministration'] = 'PPT-Buck verwaltung';
