...
/**
 * Language strings for mod_pptbook (en).
 *
 * @package    mod_pptbook
...
$string['page'] = 'Page {$a}';
$string['perpage'] = 'Slides Per Page';
$string['perpagedesc'] = 'Determine how many slides you want shown on each page';
